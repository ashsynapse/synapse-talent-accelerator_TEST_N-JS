        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="flex justify-center items-center mb-12">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-synapse-primary/50 to-synapse-secondary/50 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 scale-110 rounded-full"></div>
