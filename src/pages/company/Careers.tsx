          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <Card className="text-center border hover:border-synapse-primary transition-colors duration-300 group">
              <CardContent className="p-6">
                <Target className="text-synapse-primary mb-4 group-hover:scale-110 transition-transform duration-300 mx-auto" size={32} />
            ...
            <Card className="text-center border hover:border-synapse-primary transition-colors duration-300 group">
              <CardContent className="p-6">
                <Sparkles className="text-synapse-primary mb-4 group-hover:scale-110 transition-transform duration-300 mx-auto" size={32} />
            ...
            <Card className="text-center border hover:border-synapse-primary transition-colors duration-300 group">
              <CardContent className="p-6">
                <Users className="text-synapse-primary mb-4 group-hover:scale-110 transition-transform duration-300 mx-auto" size={32} />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-none shadow-soft">
              <CardContent className="p-8">
                <Sparkles className="text-synapse-primary mb-4" size={32} />
            ...
            <Card className="border-none shadow-soft">
              <CardContent className="p-8">
                <Users className="text-synapse-primary mb-4" size={32} />
            ...
            <Card className="border-none shadow-soft">
              <CardContent className="p-8">
                <Heart className="text-synapse-primary mb-4" size={32} />
